...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Update User <small>iWORLAIS users</small></h2>&nbsp;
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate action="<%=request.getContextPath() + "/Administrator"%>" id="resetPasswordForm" method="POST" >
                        <input type="hidden" name="a" value="<%=Constants.ACTION_ADMINISTRATOR_UPDATE_PASSWORD_USER%>" />
                        <input type="hidden" name="i" value="<%=user.getId()%>" />
                        <span class="section">Reset Password For <%=user.getFullName()%></span>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <a href="<%=request.getContextPath() + "/Administrator?a=" + Constants.ACTION_ADMINISTRATOR_EDIT_USER + "&i=" + user.getId()%>" type="submit" class="btn btn-primary">Cancel</a>
