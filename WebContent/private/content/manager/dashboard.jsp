<%-- 
    Document   : Administrator - Dashboard
    Created on : Sep 20, 2016, 9:00:28 AM
    Author     : Yoseph Berhanu<yoseph@artisan.et>
--%>
<%@page import="et.artisan.cn.cps.dto.ClaimDetailParamModel"%>
<%@page import="et.artisan.cn.cps.dto.ClaimParamModel"%>
<%@page import="et.artisan.cn.cps.dto.ClientRegionsParamModel"%>
<%@page import="et.artisan.cn.cps.dto.PaymentQueryParameter"%>
...
<div class="">
    ...
    <div class="row top_tiles">
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count"><%=CommonStorage.getRepository().getAllDocuments().size()%></div>

                <h3>Documents</h3>
                <p>Total Number of documents registered.</p>
            </div>
        </div>
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count"><%=CommonStorage.getRepository().getAllPayments(new PaymentQueryParameter()).size()%></div>

                <h3>Payments</h3>
                <p>Total count of payments registered.</p>
            </div>
        </div>
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count"><%=CommonStorage.getRepository().getAllClaims(new ClaimParamModel()).size()%></div>

                <h3>Claims</h3>
                <p>Total number of claims reported.</p>
            </div>
        </div>
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count"><%=CommonStorage.getRepository().getAllClaimDetails(new ClaimDetailParamModel()).size()%></div>

                <h3>Posted</h3>
                <p>Total number of posted payments.</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Claim Summary <small>Weekly progress</small></h2>
                    <div class="filter">
                            ...
                            <ul class="list-unstyled top_profiles scroll-view">
                                <li class="media event">
                                    ...
                                    <div class="media-body">
                                        <a class="title" href="#">Seble Nigussie</a>
                                        <p><strong>ETB 23,000. </strong> Claims Posted </p>
                                        <p> <small>12 Claims Today</small>
                                        </p>
                                    </div>
                                </li>
                                <li class="media event">
