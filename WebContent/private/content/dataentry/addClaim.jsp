...
<%
    ...
    if (request.getAttribute("claim") != null) {
        claim = (Claim) request.getAttribute("claim");
    }
%>
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate action="<%=request.getContextPath() + "/DataEntry"%>" id="addClaimForm" method="POST" enctype="multipart/form-data" >
                        <input type="hidden" name="a" value="<%=Constants.ACTION_DATAENTRY_SAVE_CLAIM%>" />
                        <div class="col-md-8 col-lg-8">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control selectpicker" data-live-search="true" id="payingBranch" name="payingBranch" data-value="<%=branchId%>">
    ...
    $(document).ready(function () {
        ...
        $('form').submit(function (e) {
            ...
            if (validator.checkAll($(this))) {
                var form = new FormData($("#addClaimForm")[0]);
                $.ajax({type: "POST",
                    ...
                    success: function (data) {
                        ...
                        new PNotify({
                            ...
                            text: data,
                            type: 'success'});
                        $("#addClaimForm").find("#submitBtn").removeAttr('disabled');
                    },
                    error: function (data) {
                        console.log(error);
                        new PNotify({
