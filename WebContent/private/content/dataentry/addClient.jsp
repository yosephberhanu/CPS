    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate action="<%=request.getContextPath() + "/DataEntry"%>" id="addClientForm" method="POST" >
                        <input type="hidden" name="a" value="<%=Constants.ACTION_DATAENTRY_SAVE_CLIENT%>" />
                        <div class="col-md-7 col-lg-7">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-4 col-md-4 col-sm-4 col-sm-3 col-xs-12" for="region">Region <span class="required">*</span>
                                </label>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control selectpicker has-feedback-right" id="region" name="region" required="required">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-12 col-lg-offset-1 col-md-offset-1">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Help - Client Registration</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
