<%-- 
    Document   : editClientRegion - DataEntry
    Created on : Apr 25, 2017, 12:55:22 PM
...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Edit Client Region</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate action="<%=request.getContextPath() + "/DataEntry"%>" id="editClientRegionForm" method="POST" >
                        <input type="hidden" name="a" value="<%=Constants.ACTION_DATAENTRY_UPDATE_CLIENT_REGION%>" />
                        ...
                        <div class="col-md-8 col-lg-8">
                            <div class="form-group">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control" id="client" name="client" data-value="<%=clientRegion.getClient().getId()%>" >
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3 col-md-4 col-sm-3 col-sm-3 col-xs-12" for=amharicName">Amharic Name
                                </label>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" name="addressLine" id="addressLine" class="form-control col-md-7 col-xs-12" placeholder="Address" value="<%=clientRegion.getAddressLine()%>" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <textarea class="form-control" id='remark' name='remark' rows="3" placeholder="Additional Remark" ><%=clientRegion.getRemark()%></textarea>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                        </div>
