...
public class BranchesListDTO {
	...
	public void setData(ArrayList<Branch> data) {
		this.data = data;
	}
	...
	public String toJSON() {
		...
		for (int i = 0; i < data.size(); i++) {
			...
			row.add(new JsonPrimitive(data.get(i).getTypeName()));
			row.add(new JsonPrimitive(data.get(i).getAddressLine()));
